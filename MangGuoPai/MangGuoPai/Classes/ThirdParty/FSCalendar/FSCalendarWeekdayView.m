...
- (void)configureAppearance
{
    ...
    for (NSInteger i = 0; i < self.weekdayPointers.count; i++) {
        ...
        /// add
        if (self.calendar.firstWeekday == 2 && self.calendar.appearance.weekHeaderViewWeekendsColor && (index == 0 || index == 6)) {
            label.textColor = self.calendar.appearance.weekHeaderViewWeekendsColor;
        }
    }
