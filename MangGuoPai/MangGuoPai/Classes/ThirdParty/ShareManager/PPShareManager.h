...
//友盟key
#define UMENG_KEY @"UMENG_KEY"
//QQ平台ID
#define QQ_PLATFORM_ID @"QQ_PLATFORM_ID"
//新浪平台ID
#define SINA_PLATFORM_ID @"SINA_PLATFORM_ID"
//微信平台ID
#define WECHAT_PLATFORM_ID @"WECHAT_PLATFORM_ID"
//微信平台Secret
#define WECHAT_PLATFORM_SECRET @"WECHAT_PLATFORM_SECRET"
//新浪平台Secret
