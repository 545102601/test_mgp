...
//    [deleteButton setImage:[UIImage imageNamed:@"record_close_icon"] forState:UIControlStateNormal];
    [deleteButton addTarget:self action:@selector(deleteImage) forControlEvents:UIControlEventTouchUpInside];
    _deleteButton = deleteButton;
    [self addSubview:deleteButton];
    
    if (!self.isSelfRecord) {
...
- (void)deleteImage
{
        ...
        [UIView animateWithDuration:SDPhotoBrowserHideImageAnimationDuration animations:^{
            ...
            if (self.delegate && [self.delegate respondsToSelector:@selector(photoBrowser:didDeleteButtonOnClick:)]) {
                [self.delegate photoBrowser:self didDeleteButtonOnClick:url.absoluteString];
            }
        }];
...
- (void)layoutSubviews
{
    ...
    _deleteButton.frame = CGRectMake(0, self.bounds.size.height - SW(48) - SH(30), SW(48), SW(48));
    _deleteButton.centerX = self.bounds.size.width * 0.5;
}
