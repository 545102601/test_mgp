 ...
 */
- (void)setPlaceholderColor2:(UIColor *)placeholderColor2
{
    _placeholderColor2 = placeholderColor2;
    
    self.placeholderView.textColor = placeholderColor2;
}
...
- (void)setPlaceholder2:(NSString *)placeholder2
{
    ...
    self.placeholderView.text = placeholder2;
}
/**
 *  通过设置_placeholderFont设置私有属性placeholderView中的Font
 */
- (void)setPlaceholderFont2:(UIFont *)placeholderFont2 {
    
    _placeholderFont2 = placeholderFont2;
    
    self.placeholderView.font = placeholderFont2;
}
